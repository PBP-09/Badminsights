...
from main.views import main_page, show_main, add_player, show_player, toggle_favorite, show_xml, show_json, show_json_by_id, show_xml_by_id, register, login_user, logout_user
